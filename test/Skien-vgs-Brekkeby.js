...
tap.equal(isFara(options), false, 'Skien vgs, avdeling brekkeby returns false from 3840 Seljord')

options.postnummer = 3841
tap.equal(isFara(options), false, 'Skien vgs, avdeling brekkeby returns false from 3841 Flatdal')
