...
tap.equal(isFara(options), false, 'Porsgrunn vgs, avdeling Nord returns false from 3672 Seljord')

options.postnummer = 3841
tap.equal(isFara(options), false, 'Porsgrunn vgs, avdeling Nord returns false from 3672 Flatdal')
