...
tap.equal(isFara(options), true, 'Bø vgs returns true from Vreimsida 83 Bø i Telemark')

options.husnummer = 927
tap.equal(isFara(options), false, 'Bø vgs returns false from Vreimsida 927 Bø i Telemark')
